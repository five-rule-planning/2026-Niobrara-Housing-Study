...
\author{Bobbi Petit, AICP \and Jordan Duffin Wong, Ph.D}
\date{}
\begin{document}
\maketitle
...
\begin{longtable*}[l]{l>{\centering\arraybackslash}p{15em}cc}
\toprule
...
\begin{center}
\includegraphics[width=1.5\linewidth,height=\textheight,keepaspectratio]{Figures/housing_age_all.png}
\end{center}
